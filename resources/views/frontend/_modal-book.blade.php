    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header bg-danger">
          <h1 class="modal-title fs-5 text-white" id="staticBackdropLabel">Book Your Stay With Us</h1>
        ...
        <div class="modal-body">
            <form action="{{ route('book.attempt') }}" method="post" role="form" id="bookForm" enctype="multipart/form-data">
                ...
                <div class="col-lg-4 col-md-6">
                    <input type="date" name="date" class="form-control @error('date') is-invalid @enderror" id="date" placeholder="Date" value="{{ old('date') }}"">
                ...
                <div class="col-lg-4 col-md-6">
                    <input type="time" class="form-control @error('time') is-invalid @enderror" name="time" id="time" placeholder="Time" value="{{ old('time') }}">
                ...
                <div class="form-group mt-3">
                    <input type="file" class="form-control @error('file') is-invalid @enderror" name="file" id="file" placeholder="Time" value="{{ old('file') }}">
