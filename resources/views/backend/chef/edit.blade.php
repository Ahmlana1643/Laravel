    ...
    <div class="card-body">
        <form action="{{ route('panel.chef.update', $chef->uuid) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name', $chef->name) }}">
            ...
            <div class="mb-3">
                ...
                <textarea name="description" id="description" cols="5" rows="5" class="form-control @error('description') is-invalid @enderror">{{ old('description', $chef->description) }}</textarea>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" name="insta_link" id="insta_link" class="form-control @error('insta_link') is-invalid @enderror" value="{{ old('insta_link', $chef->insta_link) }}">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" name="linked_link" id="linked_link" class="form-control @error('linked_link') is-invalid @enderror" value="{{ old('linked_link', $chef->linked_link) }}">
            ...
            {{-- photo --}}
                <div class="mb-3">
                    ...
                    @if ($chef->photo)
                        <div class="mt-2">
                            <img src="{{ asset('storage/'.$chef->photo) }}" class="img-fluid" alt="{{ $chef->name }}" width="20%">
                        </div>
                    @endif
