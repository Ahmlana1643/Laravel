...
<div class="py-4">
    ...
    <div class="d-flex justify-content-between w-100 flex-wrap">
        ...
        <div>
            <button type="button" data-bs-toggle="modal" data-bs-target="#downloadModal" class="btn btn-success d-inline-flex align-item-center text-white"><i class="fas fa-file-excel me-1"></i> Download</button>
        </div>
        @endif
    </div>
</div>
                ...
                <tbody>
                    @forelse ($transactions as $item)
                        <tr>
                            ...
                            <td>
                                <div>
                                    <a href="{{ route('panel.transaction.show', $item->uuid) }}" class="btn btn-sm btn-info"><i class="fas fa-eye"></i></a>
                                    @if (auth()->user()->role == 'operator')
                                    <button type="button" class="btn btn-sm btn-primary" onclick="confirmModal(this)" data-uuid="{{ $item->uuid }}"><i class="fas fa-edit"></i></button>
