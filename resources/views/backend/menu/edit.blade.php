    ...
    <div class="card-body">
        <form action="{{ route('panel.menu.update', $menu->uuid) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <textarea name="description" id="description" cols="5" rows="5" class="form-control @error('description') is-invalid @enderror">{{ old('description', $menu->description) }}</textarea>
            ...
            <div class="row">
                <div class="col-md 6">
                    <div class="mb-3">
                        ...
                        <input type="number" name="price" id="price" min="0" class="form-control @error('price') is-invalid @enderror" value="{{ old('price' , $menu->price) }}">
            ...
            <div class="mb-3">
                ...
                @if ($menu->image)
                    <div class="mt-2">
                        <img src="{{ asset('storage/'.$menu->image) }}" class="img-fluid" alt="{{ $menu->name }}" width="20%">
                    </div>
                @endif
