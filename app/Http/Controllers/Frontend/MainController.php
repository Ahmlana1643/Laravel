...
class MainController extends Controller
{
    ...
    {
        $chefs = DB::table('chefs')->orderBy('id', 'desc')->limit(6)->get(['name', 'position', 'description', 'photo', 'insta_link', 'linked_link' ]);

        $events = DB::table('events')->orderBy('id', 'desc')->get(['name', 'description', 'price', 'image' ]);
